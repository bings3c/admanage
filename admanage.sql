...
(1, '2015-08-16 10:39:46', '10', '16', '8', '2015', 'CPC'),
(1, '2015-08-16 11:07:09', '11', '16', '8', '2015', 'CPC');
...
CREATE TABLE IF NOT EXISTS `floatcard` (
  ...
  `md5Pwd` varchar(50) NOT NULL COMMENT 'md5加密密码',
  `TrafficCardType` varchar(15) NOT NULL COMMENT '流量卡类型',
  `state` varchar(10) NOT NULL COMMENT '激活状态',
  `AdUserPhone` varchar(11) NOT NULL COMMENT '用户手机号',
  `UserPoints` varchar(15) NOT NULL COMMENT '用户所花积分数',
...
INSERT INTO `floatcard` (`TrafficCardID`, `TrafficCardNum`, `TrafficCardPwd`, `md5Pwd`, `TrafficCardType`, `state`, `AdUserPhone`, `UserPoints`) VALUES
(1, '123456', '123456', 'e10adc3949ba59abbe56e057f20f883e', '流量卡', '未激活', '18923212345', '100');
